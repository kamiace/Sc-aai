...
data class PlanRequest(
    ...
    val device_context: DeviceContextCapsule? = null,
    val app_context: AppContextCapsule? = null,
    val screen_delta: ScreenDelta? = null,
    val context_level: String = ContextSharingLevel.STANDARD.name,
)
