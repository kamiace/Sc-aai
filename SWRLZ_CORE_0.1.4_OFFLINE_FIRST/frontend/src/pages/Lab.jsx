  ...
  return (
    <div className="grid lg:grid-cols-2 gap-4">
      <Panel
        ...
        right={<span className="font-mono text-[10px] text-[#D4AF37]">configured mentor</span>}
      >
      ...
      <Panel title="Plan · Output" right={<Sigil ch="Ω" />}>
        {!result && !busy && (
          <div className="text-xs font-mono text-[#5A5A5E]">
            ▸ feed a goal + accessibility nodes. The configured Mentor will return an ordered batch of actions.
          </div>
        )}
